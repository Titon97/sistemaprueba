...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SISTEMA ACAP</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <?php if($_SESSION['S_ROL']=='Administrador') {?>
          <li class="nav-item">
            <a onclick="cargar_contenido('contenido_principal','personas/personas.php')" class="nav-link">
          ...
          <li class="nav-item">
            <a onclick="cargar_contenido('contenido_principal','area/area.php')" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Area
              </p>
  ...
  <div class="content-wrapper" id="contenido_principal">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Bienvenido al sistema ACAP</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">ACAP</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
